...
VanillaTilt.init(document.querySelector(".main-content-image"), {
  ...
  "max-glare": 0.5,
        ...
        document.addEventListener("selectstar", function(event) {
            event.preventDefault();
        });

        document.addEventListener("dragstar", function(event) {
        ...
        document.querySelector("#post-49 > div > div > div:nth-child(6)")
